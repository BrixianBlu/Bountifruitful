...
public class BountifruitfulConfiguredFeatures {
    public static final RegistryKey<ConfiguredFeature<?, ?>> MANGOSTEEN_KEY = registerKey("mangosteen_tree");
    ...
    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Identifier.of(Bountifruitful.MOD_ID));
    }
