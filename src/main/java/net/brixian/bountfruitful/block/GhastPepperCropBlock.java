...
import net.brixian.bountfruitful.BountifruitfulItems;
...
public class GhastPepperCropBlock extends SoulSandPlantBlock implements Fertilizable {
    ...
    public GhastPepperCropBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)((BlockState)this.stateManager.getDefaultState()).with(AGE, 0));
    }

    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(BountifruitfulItems.GHAST_PEPPER_SEEDS);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(BountifruitfulItems.GHAST_PEPPER, j + (bl ? 1 : 0)));
            world.playSound((PlayerEntity)null, pos, SoundEvents.BLOCK_GROWING_PLANT_CROP, SoundCategory.BLOCKS, 1.0F, 0.8F + world.random.nextFloat() * 0.4F);
